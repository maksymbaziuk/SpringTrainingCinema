...
@ContextConfiguration(classes = {NotLuckyWinnerAspectTestConfig.class})
public class NotLuckyWinnerAspectTest {
...
class NotLuckyWinnerAspectTestConfig {
